...
- 两个 workflow 都通过 `jdx/mise-action` 读取根目录 `mise.toml`，固定 Node `24.21.0` 和 pnpm `11.27.1`；这是项目工具链版本。GitHub Action 自身的 Node runtime 独立于项目 Node，应使用支持 Node 24 的 checkout、cache 和 artifact action。
